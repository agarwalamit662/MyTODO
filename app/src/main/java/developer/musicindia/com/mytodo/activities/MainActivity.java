...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrList = DTOProviderTODO.getTODOListinDatabase(MainActivity.this);
    ...
    public static class TODORecyclerViewAdapter
                    ...
                    animFade.setAnimationListener(new Animation.AnimationListener() {
                        ...
                        public void onAnimationEnd(Animation animation) {
                            ...
                            if(mValues.get(position).getCompleted() == 0){
                                ...
                                DTOProviderTODO.updateTODOIteminDatabase(mContext,item.getTodoId(),values);
                        ...
                        public void onAnimationEnd(Animation animation) {
                            ...
                            alertDialogBuilder.setPositiveButton("yes", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int arg1) {
                                    ...
                                    DTOProviderTODO.deleteTODOfromDatabase(mContext, todo.getTodoId());
